          ...
          >
            <form onSubmit={(e) => handleSubmit(onSubmit, e)} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-gradient-to-r from-[#00249C] to-[#01BEDB] text-white font-semibold py-3 px-4 rounded-lg 
                           hover:from-[#01BEDB] hover:to-[#00249C] focus:ring-2 focus:ring-[#00249C] focus:ring-offset-2 
              ...
              <div className="text-center">
                <span className="text-[#00249C] text-sm font-montserrat font-medium">¿No tienes cuenta?</span>
              </div>
              ...
              <Link href={getRoutePath("/register")}>
                <motion.button
                  ...
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="w-full border-2 border-[#00249C] text-[#00249C] font-semibold py-3 px-4 rounded-lg 
                             hover:bg-[#00249C] hover:text-white transition-all duration-200 font-montserrat
                             shadow-lg hover:shadow-xl cursor-pointer"
                >
                  Crear Nueva Cuenta
                </motion.button>
